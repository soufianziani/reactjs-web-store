  ...
  const handleSubmit = (e) => {
    ...
    if (name && email && password1 && password1 === password2) {
      axios
        ...
        .then((res) => {
          alert("nouvel utilisateur inséré");
      ...
      <main className="w-full flex">
            <div className="relative flex-1 hidden items-center justify-center h-screen bg-gray-900 lg:flex">
                ...
                <div
                    ...
                    style={{
                        backgroundImage: "url(https://i.pinimg.com/564x/ef/b5/97/efb597b6b6c57d5f871255c3cec40ef7.jpg)",    backgroundSize: "cover" ,  width: "100%", height: "100%",
                    }}
                >
                ...
                <div className="w-full max-w-md space-y-8 px-4 bg-white text-gray-600 sm:px-0">
                    <div className="">
                        ...
                        <div className="mt-5 space-y-2">
                            ...
                            <p className="">Arelady have an account? <Link to="/Login"><a  className="font-medium text-[#B64E18] hover:text-[#A47249]">Login</a></Link></p>
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <button
                         ...
                         className="w-full px-4 py-2 text-white font-medium bg-[#B64E18]  hover:bg-[#A47249] active:bg-[#B64E18] rounded-lg duration-150"
                        >
                           Sign in
                        </button>
                    </form>
