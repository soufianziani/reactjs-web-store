...
const Login = () => {
  ...
  const HandleSubmit = async () => {
    setLoading(true);
    await axios
      .get(`http://localhost:3030/users?email=${email}`)
      .then((res) => {
    ...
    <main className="w-full flex">
      <div className="relative flex-1 hidden items-center justify-center h-screen bg-gray-900 lg:flex">
        <div className="relative z-10 w-full max-w-md">
          <div className=" mt-16 space-y-3"></div>
        </div>
        <div
          className="absolute inset-0 my-auto h-[500px]"
          style={{
            backgroundImage:
              "url(https://i.pinimg.com/564x/df/bc/53/dfbc533aea69a37ac5336709226bda54.jpg)",
          ...
          <div className="">
            <div className="mt-5 space-y-2">
              ...
              <p className="">
                Not have an account?{" "}
                <Link to="/register">
                  <a className="font-medium text-[#B64E18] hover:text-[#A47249]">
                    Sign Up
                  </a>
                </Link>
              </p>
